...
every :day, :at => '03:00am' do
  ...
  command "EC2_HOME=/usr/local/ec2-api-tools-1.6.11.0 JAVA_HOME=/usr /usr/local/ec2-api-tools-1.6.11.0/bin/ec2-create-snapshot -K #{pk} -C #{cert} vol-b26fb1c2", :output => '~/log/snapshot.log'
end
